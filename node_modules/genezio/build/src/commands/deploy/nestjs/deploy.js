...
export async function nestJsDeploy(options) {
    ...
    const environmentVariables = await createBackendEnvVarList(options.env, options.stage, genezioConfig, SSRFrameworkComponentType.nestjs);
    const result = await deployFunction(genezioConfig, options, componentPath, environmentVariables);
