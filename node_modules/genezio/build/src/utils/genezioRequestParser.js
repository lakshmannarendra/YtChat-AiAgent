 ...
 */
function bodyIsBinary(rawContentType) {
    if (!rawContentType) {
        return true;
    }
    ...
    if (contentType.type === "text") {
        ...
        return !["json", "ld+json", "x-httpd-php", "x-sh", "x-csh", "xhtml+xml", "xml"].includes(contentType.subtype);
}
/**
 * Express JS middleware that parses the request similar to how AWS API Gateway does it.
 */
export const genezioRequestParser = (request, response, next) => {
