...
export function getDartSdkVersion() {
...
export async function checkIfDartIsInstalled() {
...
export function getDartAstGeneratorPath(dartSdkVersion) {
    return {
        directory: path.join(os.homedir(), ".genezio", ".dart_ast_generator"),
        path: path.join(os.homedir(), ".genezio", ".dart_ast_generator", `genezioDartAstGenerator_${dartSdkVersion}_v0.1.aot`),
    };
}
