...
export const GENEZIO_NO_CLASSES_FOUND = (language) => {
    let decoratorSyntax = "";
    switch (language) {
        case Language.ts:
        case Language.js:
    ...
    let errorMessage = "You don't have any class or function specified in the genezio.yaml configuration file.";
    if (decoratorSyntax) {
...
export const GENEZIO_CLASS_STATIC_METHOD_NOT_SUPPORTED = "Static methods are not supported in Genezio classes.";
export const GENEZIO_PLEASE_REPORT_ISSUE = "Three was a problem on our side. Please report this issue at https://github.com/genez-io/genezio/issues.";
...
export const ADD_DATABASE_CONFIG = function (name, region) {
